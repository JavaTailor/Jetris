...
import config.PlatformAttr;
import execute.loader.LoaderHelper;
import soot.*;
...
public class ClassUtils {
    ...
    public static void initReplaySootEnvWithClassPath(String classPath){

//        String claspath = System.getProperty("java.class.path");
//        System.out.println(claspath);
        String claspath = "/Users/yingquanzhao/Workspace/JVM/02JIT/Projects/JITFuzzing/Main/target/classes:" +
                "/Users/yingquanzhao/Workspace/JVM/02JIT/Projects/JITFuzzing/DTJVM/target/classes:" +
                "/Users/yingquanzhao/Workspace/JVM/02JIT/Projects/JITFuzzing/Fuzzing/target/classes";
        claspath = claspath + System.getProperty("path.separator") + LoaderHelper.parseLibString(new File("/Users/yingquanzhao/Workspace/JVM/02JIT/Projects/JITFuzzing/runtime/lib/"));
        claspath = claspath + System.getProperty("path.separator") + LoaderHelper.parseLibString(new File("/Users/yingquanzhao/Workspace/JVM/02JIT/Projects/JITFuzzing/runtime/jre/lib/"));
        claspath = claspath + System.getProperty("path.separator") + LoaderHelper.parseLibString(new File("/Users/yingquanzhao/Workspace/JVM/02JIT/Projects/JITFuzzing/lib/"));
...
//            e.printStackTrace();
    ...
    public static ClassInfo loadClassInfo(String classname){
        ...
        try {
            ...
            Scene.v().loadNecessaryClasses();
            Chain<SootClass> classes = Scene.v().getClasses();
            return ClassInfo.analyseClass(sootClass);
        } catch (Exception e){
//            e.printStackTrace();
            return null;
        }
    ...
    public static void saveClassToPath(SootClass sootClass, String dirPath){
        ...
        String jimpleFilePath = dirPath + PlatformAttr.FILE_SEPARATOR + sootClass.getName()  + ".jimple";
        String classFilePath = dirPath + PlatformAttr.FILE_SEPARATOR + sootClass.getName()  + ".class";
        try{
