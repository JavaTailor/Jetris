...
public class ExecutionPlatform {
    ...
    public static String RUNNABLE_CLASS_LOADER = "execute.loader.RunnableClassLoader";
    ...
    private static ExecutionPlatform tp;
    ...
    public static String getJavaClassPath(){
        ...
        String[] paths;
        if (ExecutionPlatform.isWin()) paths = classPath.split(";");// windows的path分隔符是;
        ...
        classPath = StringUtils.join(classPaths, ExecutionPlatform.PATH_SEPARATOR);
        return classPath;
    }

    public static ExecutionPlatform getInstance() {

        if (tp == null){
            tp = new ExecutionPlatform();
        }
        return tp;
    }
