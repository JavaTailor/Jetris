        ...
        for (String key : results.keySet()) {
            ...
            if (!jvmOut.getOutput().isEmpty()){
                ...
                for (String output : outputs) {
                	...
                	if(output.contains("Segmentation error")
                            || output.contains("core dump")
                            || output.contains("javacore.")
                            || output.contains("dumped core")
                            || output.contains("A fatal error has been detected")){
